#ifndef BIG_MONSTER_H
#define BIG_MONSTER_H
#include "utility.h"
#include "map.h"

extern const uint32_t GAME_TICK_CD;

class BIG_MONSTER : OBJECT {
public:
	BIG_MONSTER(int grid_x, int grid_y, const char* name, Map* map);
	BIG_MONSTER(const char* _name, Map* map);
	~BIG_MONSTER();
	void draw() override;
